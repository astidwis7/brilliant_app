    ...
    <main class="main" id="top">
        ...
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <li class="nav-item px-2"><a class="nav-link active" aria-current="page" href="{{route('participan.index')}}">Home</a></li>
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="{{route('participan.account_')}}">My Profile</a></li>
           </ul>
           <!-- <a class="btn btn-primary order-1 order-lg-0" href="#!">Sign Up</a> -->
      ...
      <section class="pb-11 pt-7 bg-600">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h6 class="font-sans-serif text-primary fw-bold">Al-Mutawasitin Course</h6>
              <h1 class="mb-6">Learning Tajwid Al-Quran<br />Mastering how to read the Quran</h1>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section style="margin-top:-21.5rem">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-8"><img class="w-100" src="assets/img/gallery/taweed.jpg" alt="..." />
              <h1 class="my-4">Description</h1>
              <h3 class="my-4">Tingkatan Level Belajar :</h3>
              <p>Dasar, menengah, lanjutan</p>
              <p>Kursus ini adalah salah satu sarana yang kami sediakan bagi Anda yang ingin mempelajari tentang tajwid dan tahsin alquran yang diharapkan bisa meningkatkan kualitas bacaan Alqur’an dari segi ilmu tajwidnya. Teknik Metode yang digunakan sangat sederhana dan mudah dipelajari oleh murid-murid, Mulai dari pengenalan huruf hija'iyah dan Iqra (Dasar), pengenalan hukum bacaan Mad Far'i dan Mad Thobi'i, Nun mati dan tanwin, Hukum Mim Mati, Qalqalah dsb. (Menengah), Tehnik membaca Al-Qur'an dengan Lagam disertai dengan tahsin yang baik dan benar (Lanjutan).</p>
              <h1>What You’ll Learn?</h1>
              <ul class="list-unstyled">
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Pengertian, Hukum Ilmu Tajwid dan Dasar-dasar Tahsin</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Kebiasaan yang perlu diperbaiki saat membaca Alqur’an</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Makhroj Huruf</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Sifat Huruf</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Nun Sukun, Tanwin, dan Mim Sukun</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Nun & Mim Tasydid, Hukum Idgham, dan Lam Ta’rif</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Mid Test</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Hamzah Qst ha’ dan Hamzah Washal</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Tafkhim dan Tarqiq</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Tanda Waqaf</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong>Saktah, Qatha’, dan Lafzhul Jalaalah</strong>&nbsp;</li>
                <li class="mb-3"> <i class="fas fa-check text-info me-2"></i><strong> Ayat-ayat Gharibah</strong>&nbsp;</li>
              </ul>
            </div>
            <div class="col-md-4">
              <div class="card">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item"><strong>Categories </strong>: Tajwid Al-Quran</li>
                  <li class="list-group-item"><strong>Level </strong>: Beginner Level</li>
                  <div class="d-grid"> <a class="btn btn-lg btn-primary" href="course-detail-1.html">Apply to Course</a></div>
        ...
        <div class="container">
          <div class="row h-100 align-items-center">
            <div class="col-md-12 col-lg-6 h-100">
              <div class="card card-span text-white h-100"><img class="w-100" src="assets/img/gallery/fe.jpeg" alt="..." />
                <div class="card-body px-xl-5 px-md-3 pt-0">
                  <div class="d-flex flex-column align-items-center bg-200" style="margin-top:-2.4rem;">
                    <h5 class="mt-3 mb-0">Ny. Erlin</h5>
                    <p class="text-muted">Beginner Level</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-12 col-lg-6 h-100">
              ...
              <div class="mt-6">
                <h5 class="font-sans-serif fw-bold mb-3">The courses that Ny. Erlin has taken</h5>
                  ...
                  <div class="card-body">
                    <div class="row flex-center gx-0">
                      ...
                      <div class="col-lg-8 col-xl-9">
                        <h5 class="font-sans-serif fw-bold"> Learning Tajwid Al-Quran Mastering how to read the Quran</h5>
                        <p class="text-muted fs--1">Al-Mutaqadimin Course</p>
                      </div>
                    </div>
                  </div>
                </div>
